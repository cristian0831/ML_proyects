...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        self.q[(state,action)] = (
                old_q + self.alpha * (new_value_estimate - old_q)
        )
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # ----------------------------
        # Compute best action(s)
        # ----------------------------
        best_q = float("-inf")
        best_actions = []

        for action in available_actions:
            q = self.get_q_value(state, action)  # returns 0 if not in self.q
        ...
        # Choose among equally good actions at random
